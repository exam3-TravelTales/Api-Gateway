...
func (h *Handler) UpdateStory(c *gin.Context) {
	...
	res, err := h.Content.UpdateStories(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) DeleteStory(c *gin.Context) {
	...
	req := pb.StoryId{}
	req.Id = c.Param("story_id")
	_, err := h.Content.DeleteStories(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) GetAllStories(c *gin.Context) {
	...
	res, err := h.Content.GetAllStories(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) GetStory(c *gin.Context) {
	...
	res, err := h.Content.GetStory(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) CommentStory(c *gin.Context) {
	...
	res, err := h.Content.CommentStory(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) GetCommentsOfStory(c *gin.Context) {
	...
	res, err := h.Content.GetCommentsOfStory(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) Itineraries(c *gin.Context) {
	...
	req.UserId = id
	res, err := h.Content.Itineraries(c, &req)
	if err != nil {
		h.Log.Error("there")
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
...
func (h *Handler) UpdateItineraries(c *gin.Context) {
	...
	res, err := h.Content.UpdateItineraries(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) DeleteItineraries(c *gin.Context) {
	...
	_, err := h.Content.DeleteItineraries(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) GetItineraries(c *gin.Context) {
	...
	res, err := h.Content.GetItineraries(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) GetItinerariesById(c *gin.Context) {
	...
	res, err := h.Content.GetItinerariesById(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
...
func (h *Handler) CommentItineraries(c *gin.Context) {
	...
	req.AuthorId = id
	res, err := h.Content.CommentItineraries(c, &req)
	if err != nil {
		h.Log.Error(err.Error())
		c.JSON(500, gin.H{"error": err.Error()})
	}
